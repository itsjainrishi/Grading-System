            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 ...
                 <div style="display: inline;float: left" id=grades-div></div>
                    ...
                    <a href="{{ route('grades.normalize', array( 'id' => $id )) }}"><button type="button" class="btn btn-primary" style="background-color: #3cb371;color: #fff;margin-top: 60px;margin-left: 80px;">Normalize</button>
                </div>
